    ...
    <div class="p-4 sm:p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 sm:items-center mb-6 gap-4">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Kelola semua produk yang tersedia di sistem</p>
            </div>
        </div>

        <div class="grid grid-cols-12 gap-4 lg:gap-6">
            {{-- TABEL PRODUK --}}
            <div class="col-span-12 lg:col-span-12 bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 dark:bg-gray-800 grid grid-cols-1">
                <div class="p-5 border-b border-gray-100 dark:border-gray-700 grid grid-cols-2 items-center">
                    <h2 class="font-semibold text-gray-900 dark:text-white">Daftar Produk</h2>
                    <a href="{{ route('products.create') }}" class="inline-flex items-center gap-1.5 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition justify-self-end">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="overflow-x-auto overflow-y-auto max-h-[300px] scrollbar-hide">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                ...
                                <td class="px-4 py-3 text-center">
                                    <span class="px-2.5 py-1 rounded-full text-xs font-medium {{ $product->stock < 10 ? 'bg-red-400 text-red-900' : ($product->stock < 20 ? 'bg-yellow-400 text-yellow-900' : 'bg-green-400 text-green-900') }}">
                                        {{ $product->stock }}
                                    </span>
                                </td>
                                <td class="px-4 py-3 text-center">
            ...
            {{-- TABEL KATEGORI --}}
            <div class="col-span-12 lg:col-span-6 bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 dark:bg-gray-800 grid grid-cols-1">
                <div class="p-5 border-b border-gray-100 dark:border-gray-700 grid grid-cols-2 items-center">
                    <h2 class="font-semibold text-gray-900 dark:text-white">Kategori</h2>
                    <a href="{{ route('categories.create') }}" class="inline-flex items-center gap-1.5 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition justify-self-end">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        Tambah Kategori
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                ...
                                <td class="px-4 py-3 text-right text-gray-500 dark:text-gray-400">{{ $category->products_count ?? $category->products?->count() ?? 0 }}</td>
                                <td class="px-4 py-3 text-center">
                                    <div class="grid grid-flow-col auto-cols-max items-center justify-center gap-2">
            ...
            {{-- TABEL PRODUCT ATTRIBUTS --}}
            <div class="col-span-12 lg:col-span-6 bg-white rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 dark:bg-gray-800 grid grid-cols-1">
                <div class="p-5 border-b border-gray-100 dark:border-gray-700 grid grid-cols-2 items-center">
                    <h2 class="font-semibold text-gray-900 dark:text-white">Atribut Produk</h2>
                    <a href="{{ route('product-attributs.create') }}" class="inline-flex items-center gap-1.5 bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-700 transition justify-self-end">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" />
                        </svg>
                        Tambah Atribut
                    ...
                    <table class="w-full text-sm text-left">
                        <thead class="bg-gray-50 dark:bg-gray-700 text-gray-600 dark:text-gray-400 font-medium sticky top-0 z-10">
                            <tr>
                                ...
                                <th class="px-4 py-3">Nama Atribut</th>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="px-4 py-8 text-center text-gray-400">Belum ada atribut produk.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
