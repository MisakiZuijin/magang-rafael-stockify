        ...
        <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <x-form.settings-section title="Identitas Aplikasi">
                ...
                <x-form.input-file
                    ...
                    hint="Format: PNG, ICO. Maks 1MB."
                    previewSize="w-12 h-12"
                    :previewUrl="(!empty($settings['favicon']) && file_exists(public_path($settings['favicon']))) ? asset($settings['favicon']) : null"
                    fallbackIcon='<svg class="w-6 h-6 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>' />
