    ...
    <div class="lg: pb-10 min-h-screen relative z-0">
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            <div class="grid grid-cols-12 gap-4 lg:gap-6">
                ...
                {{-- TABEL TRANSAKSI --}}
                @php
                $headers = ['ID', 'Nama Product', 'Nama User', 'Type', 'Quantity', 'Status', 'Note', 'Aksi'];
                @endphp
                ...
                {{-- TABEL PRODUK --}}
                @php
                $productHeaders = ['ID', 'Nama', 'Harga Beli', 'Harga Jual', 'Stock', 'Min', 'Aksi'];
                @endphp
