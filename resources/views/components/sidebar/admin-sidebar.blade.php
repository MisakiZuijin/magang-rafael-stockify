<x-sidebar-dashboard>
    ...
    {{-- Setting --}}
    <li>
        <a href="{{ url('/settings') }}" class="flex items-center p-2 text-base font-medium rounded-lg group
            {{ request()->is('settings*') ? 'bg-blue-100 text-blue-700 dark:bg-blue-700 dark:text-white' : 'text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700' }}">
            <svg class="w-6 h-6 transition duration-75 {{ request()->is('settings*') ? 'text-blue-700 dark:text-white' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' }}" fill="currentColor" viewBox="0 0 20 20">
