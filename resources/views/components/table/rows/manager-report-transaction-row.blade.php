...
<tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
    ...
    <td class="px-4 py-3 text-center">
        <a href="{{ route('manager.transactions.show', $trx->id) }}" class="p-1.5 text-purple-600 hover:bg-purple-50 dark:hover:bg-purple-900/20 rounded-lg transition" title="Detail">
