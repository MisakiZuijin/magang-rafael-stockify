{{-- resources/views/components/table/rows/admin-product-row.blade.php --}}
@props(['product'])
...
<tr class="hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
    ...
    <td class="px-4 py-3 text-center">
        <div class="grid grid-flow-col auto-cols-max items-center justify-center gap-2">
            ...
            {{-- Detail --}}
            <a href="{{ route('products.show', $product->id) }}" class="p-1.5 text-blue-600 hover:bg-blue-50 rounded-lg transition" title="Detail">
